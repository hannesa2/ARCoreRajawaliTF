...
public class FbxDemo2Render extends DeerGirlARCoreRenderer {
    ...
    public FbxDemo2Render(@NotNull Context context, @NotNull TapHelper tapHelper, @NotNull Session session) {
...
//                LoaderFBX parser = new LoaderFBX(renderer, R.raw.deergirl_ch_cloth);
                LoaderFBX parser = new LoaderFBX(renderer, 0);
                parser.parse();
                object3D = parser.getParsedObject();
                object3D.setY(-.5f);
                object3D.setPosition(0.0, 0.0, -0.5);
            } catch (ParsingException e) {
                Log.e("fcc", "FbxDemo2 dIB error: "+e);
                e.printStackTrace();
            }
            Log.e("fcc", "FbxDemo2 dIB end");
            return null;
        }

        @Override
        protected void onPostExecute(Object o) {
            Log.e("fcc", "FbxDemo2 dIB oPE");
